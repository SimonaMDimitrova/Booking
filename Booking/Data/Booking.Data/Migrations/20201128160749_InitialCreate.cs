        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PropertyCategories_PropertyTypes_PropertyTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OfferFacilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OfferFacilities_Facilities_FacilityId",
                        column: x => x.FacilityId,
                        principalTable: "Facilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OfferFacilities_FacilityId",
                table: "OfferFacilities",
                column: "FacilityId");

            migrationBuilder.CreateIndex(
                name: "IX_OfferFacilities_IsDeleted",
                table: "OfferFacilities",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_OfferFacilities_OfferId",
                table: "OfferFacilities",
                column: "OfferId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyCategories_PropertyTypeId",
                table: "PropertyCategories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PropertyRules_IsDeleted",
                table: "PropertyRules",
                column: "IsDeleted");
